...
# ✅ FIXED — Use your actual MiniLM model folder
MODEL_DIR = "models/microsoft-MiniLM-L12-H384"

BATCH_SIZE = 16
os.makedirs("precomputed_features/minilm", exist_ok=True)
...
# ---------------- Compute / Load ----------------
train_p = cached("precomputed_features/minilm/train_perp.npy", get_perplexity, X_train.tolist())
test_p  = cached("precomputed_features/minilm/test_perp.npy", get_perplexity, X_test.tolist())

train_d = cached("precomputed_features/minilm/train_div.npy", get_div, X_train.tolist())
test_d  = cached("precomputed_features/minilm/test_div.npy", get_div, X_test.tolist())

train_e = cached("precomputed_features/minilm/train_emb.npy", get_embeds, X_train.tolist())
test_e  = cached("precomputed_features/minilm/test_emb.npy", get_embeds, X_test.tolist())
...
for n, m in models.items():
    ...
    joblib.dump(m, f"models/polydetect_minilm_{n.lower()}.joblib")

df_res = pd.DataFrame(results)
df_res.to_csv("metrics_minilm.csv", index=False)
...
print("\n--- Results ---")
print(df_res)
print("✅ Training complete for MiniLM-L12-H384.")