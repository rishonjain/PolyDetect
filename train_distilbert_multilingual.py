# train_distilbert_multilingual.py — FINAL
...
MODEL_DIR="models"
ENCODER_KEY="distilbert"
ENCODER_PATH=os.path.join(MODEL_DIR,"distilbert-base-multilingual-cased")
...
def get_emb(xs):
    outs=[]
    for i in tqdm(range(0,len(xs),BATCH),desc="DistilBERT embeddings"):
        batch=xs[i:i+BATCH]
...
def save_model(clf,name):
    ...
    meta={"encoder":ENCODER_KEY,"embedding_dim":emb_dim,
